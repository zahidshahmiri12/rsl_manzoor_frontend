...
import { AppBar, Button, Card, CardActions, CardContent, Dialog, DialogActions, DialogContent, DialogTitle, List, TextField, Toolbar, Typography } from '@mui/material'
...
export default function Location() {
    ...
    const handleDelete = async (id,e) =>{
        e.preventDefault();
        await api.delete(`/deleteLocation/${id}`)
        .then(res=>{
            ...
            <Box sx={{
                ...
                <List>
                {
                    locationData.map((items) => {
                        return (
                            <Card elevation={6} key={items.id} sx={{
                                display: "flex",
                                ...
                                <CardActions>
                                    <Button onClick={(e) => handleEdit(items.id,e)} varirnt="outlined" size="small">
                                        <EditIcon color="action" />
                                    </Button>
                                    <Button onClick={(e) => handleDelete(items.id,e)} varirnt="outlined" size="small">
